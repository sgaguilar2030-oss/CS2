...
## Version v1.0.4 - December 4, 2025
- Fifth version of the program.
- User can:
    - See if they failed / Passed
- Updates:
    - Edited accuracy of the GWA Table
## Version v1.0.5 - January 29, 2026
- Updates:
  - Edited grammar

## Version v1.0.6 - February 16, 2026
...
## Version v1.1.4 - April 15, 2026
- Fourteenth version of the program
- Major update released, Converted from Command Line Interface (CLI) to Graphical User Interface (GUI).
- User can:
  - Edit previous inputs
  - Navigate through a scrollable interface
  - Input and calculate grades through interactive dialogs
- Fixed a bug, Fixed incorrect "already surpassed" message in Desired Grade calculation.
- Fixed a bug, Fixed incorrect formula usage for percentage vs GWA confusion.
